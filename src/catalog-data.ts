...
export const officialSources: OfficialSource[] = [
  ...
  { name: "文心一言", url: "https://yiyan.baidu.com", purpose: "文心一言产品入口", checkedAt: "2026-06-11" },
  { name: "ERNIE 官网", url: "https://ernie.baidu.com", purpose: "ERNIE 模型和博客", checkedAt: "2026-06-11" },
  { name: "百度智能云", url: "https://cloud.baidu.com", purpose: "文心大模型 API", checkedAt: "2026-06-11" },
  ...
  { name: "ERNIE 5.1 发布博客", url: "https://ernie.baidu.com/blog/zh/posts/ernie-5.1-0508-release/", purpose: "文心 5.1 发布详情", checkedAt: "2026-06-11" },
  ...
  { name: "文心快码文档中心", url: "https://comate.baidu.com", purpose: "功能介绍和配置", checkedAt: "2026-06-11" },
...
export const companies: Company[] = [
  ...
  },
  {
    ...
    docsUrl: "https://cloud.baidu.com",
    summary: "产业级知识增强大模型，ERNIE 系列模型",
    sourceUrls: ["https://yiyan.baidu.com", "https://ernie.baidu.com", "https://cloud.baidu.com"],
    checkedAt: "2026-06-11",
    notes: "生态以百度云为中心",
  },
];
...
export const models: Model[] = [
  ...
  },
  {
    ...
    sourceUrls: ["https://www.moonshot.ai"],
    checkedAt: "2026-06-11",
  ...
  },
  {
    ...
    availability: "API",
    bestFor: "多模态理解、Agent、搜索增强",
    sourceUrls: ["https://ernie.baidu.com/blog/zh/posts/ernie-5.1-0508-release/", "https://cloud.baidu.com"],
    checkedAt: "2026-06-11",
    notes: "预训练成本仅为业界同规模 6%",
  },
];
...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    toolType: "通用任务 Agent",
    audiences: ["研发", "产品"],
    bestFor: "复杂推理、长程编码、多步骤 Agent 任务",
    website: "https://www.anthropic.com",
    sourceUrls: ["https://www.anthropic.com"],
    checkedAt: "2026-06-11",
    notes: "支持 MCP、代码执行、记忆工具",
  },
  {
    id: "gemini-platform",
  ...
  },
  {
    ...
    toolType: "通用任务 Agent",
    audiences: ["研发", "产品"],
    bestFor: "编码、分析、长上下文理解、Agent 自主执行",
    website: "https://www.moonshot.ai",
    sourceUrls: ["https://www.moonshot.ai"],
    checkedAt: "2026-06-11",
  ...
  },
  {
    ...
    name: "MiniMax Agent",
    companyId: "minimax",
    modelProviderIds: ["minimax"],
    toolType: "通用任务 Agent",
    audiences: ["研发", "产品"],
    bestFor: "通用 Agent 平台、编码辅助",
    website: "https://www.minimax.io",
    sourceUrls: ["https://minimax.io"],
    checkedAt: "2026-06-11",
    notes: "基于 MiniMax M3/M2.5 模型",
  },
  {
    id: "autoglm",
    name: "AutoGLM",
  ...
  },
  {
    ...
    name: "文心快码 (Comate)",
    companyId: "baidu-wenxin",
    modelProviderIds: ["baidu-wenxin"],
    toolType: "编码 Agent",
    audiences: ["研发"],
    bestFor: "企业级编码 Agent、Multi-Agent 架构、SPEC 模式",
    website: "https://comate.baidu.com",
    sourceUrls: ["https://comate.baidu.com"],
    checkedAt: "2026-06-11",
    notes: "支持私有化部署",
  },
  {
